...
> **Assignee**: 🔴 Hoàng (Lead) + 🟡 Teammate (Tests, Docs)  
...
- [ ] 🟡 Teammate: Test healing actions riêng lẻ (manual trigger each action)
- [ ] 🟡 Teammate: Viết API docs cho Hephaestus endpoints
