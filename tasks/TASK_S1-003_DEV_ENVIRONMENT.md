...
> **Assignee**: 🔴 Hoàng (Lead) + 🟡 Teammate (Research)  
> **Blocked by**: S1-001  
...
> và các công cụ hỗ trợ. Teammate đọc + tóm tắt papers nghiên cứu.
...
- [ ] 🟡 Teammate: Đọc + tóm tắt paper ADARMA (1-2 trang)
- [ ] 🟡 Teammate: Viết README v1 cho project
...
> **Template cho Teammate — README outline:**
