...
│ • ...      │            │            │            │            │                │
├────────────┴────────────┴────────────┴────────────┴────────────┴────────────────┤
│ 🔴 = Bạn (Lead)    🟡 = hp8001 (Support)    ⛔ = Blocked (cần giải quyết)   │
└────────────────────────────────────────────────────────────────────────────────────┘
```
...
| IN PROGRESS  | **3**     | 2 cho Bạn + 1 cho hp8001. KHÔNG được vượt quá!  |
...
#### 🟡 hp8001 (Support Developer) — ~30% workload
...
### 5.3. Hướng dẫn phân task hiệu quả cho hp8001
...
**Checklist khi giao task cho hp8001:**
...
| 3 | Tóm tắt 5 papers quan trọng nhất       | 🟡 hp8001  | 4 ngày | P1       |
| 4 | Vẽ architecture diagrams (Draw.io)      | 🟡 hp8001  | 2 ngày | P1       |
...
| 4 | Customize Grafana dashboards                  | 🟡 hp8001  | 3 ngày |
| 5 | Viết test cases cho Gaia                      | 🟡 hp8001  | 2 ngày |
| 6 | Thu thập baseline metrics (before attack)     | 🟡 hp8001  | 2 ngày |
...
| 4 | Tạo OWASP attack template library             | 🟡 hp8001  | 3 ngày |
| 5 | Test từng loại attack riêng lẻ                | 🟡 hp8001  | 3 ngày |
| 6 | Ghi log + record kết quả attack              | 🟡 hp8001  | 2 ngày |
...
| 5 | Test healing actions riêng lẻ                 | 🟡 hp8001  | 3 ngày |
| 6 | Viết docs cho Hephaestus API                  | 🟡 hp8001  | 2 ngày |
...
| 4 | Thu thập data: MTTD, MTTR, Uptime            | 🟡 hp8001  | 3 ngày |
| 5 | Record video demo (toàn bộ flow)              | 🟡 hp8001  | 2 ngày |
| 6 | Tạo bảng so sánh Baseline vs Self-Healing     | 🟡 hp8001  | 2 ngày |
...
| 2 | Viết báo cáo — phần bối cảnh + related works  | 🟡 hp8001  | 4 ngày |
| 3 | Tạo slides bảo vệ                            | 🟡 hp8001  | 3 ngày |
| 4 | Review + chỉnh báo cáo                       | 🔴 Bạn       | 3 ngày |
| 5 | Đóng gói source code (clean, docs)            | 🔴 Bạn       | 2 ngày |
| 6 | Tập bảo vệ (dry run)                         | Cả 2         | 2 ngày |
| 7 | Làm poster (nếu cần)                         | 🟡 hp8001  | 2 ngày |
...
| D4  | **Được review** (nếu là code)     | Lead (bạn) đã review code của hp8001               |
...
| "hp8001 không biết làm gì"    | Template rõ ràng + pair programming 30 phút đầu |
