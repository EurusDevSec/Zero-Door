...
│ • ...      │            │            │            │            │                │
├────────────┴────────────┴────────────┴────────────┴────────────┴────────────────┤
│ 🔴 = Bạn (Lead)    🟡 = hpt8001 (Support)    ⛔ = Blocked (cần giải quyết)   │
└────────────────────────────────────────────────────────────────────────────────────┘
```
...
| IN PROGRESS  | **3**     | 2 cho Bạn + 1 cho hpt8001. KHÔNG được vượt quá!  |
...
#### 🟡 hpt8001 (Support Developer) — ~30% workload
...
### 5.3. Hướng dẫn phân task hiệu quả cho hpt8001
...
**Checklist khi giao task cho hpt8001:**
...
| 3 | Setup GitHub Projects board       | 🟡 hpt8001  | 1 ngày | P0       |
| 4 | Đọc + tóm tắt paper ADARMA       | 🟡 hpt8001  | 3 ngày | P1       |
| 5 | Setup dev environment (Java, Go)  | 🔴 Bạn       | 1 ngày | P0       |
| 6 | Viết README v1                    | 🟡 hpt8001  | 1 ngày | P2       |
...
| 3 | Tóm tắt 5 papers quan trọng nhất       | 🟡 hpt8001  | 4 ngày | P1       |
| 4 | Vẽ architecture diagrams (Draw.io)      | 🟡 hpt8001  | 2 ngày | P1       |
...
| 4 | Customize Grafana dashboards                  | 🟡 hpt8001  | 3 ngày |
| 5 | Viết test cases cho Gaia                      | 🟡 hpt8001  | 2 ngày |
| 6 | Thu thập baseline metrics (before attack)     | 🟡 hpt8001  | 2 ngày |
...
| 4 | Tạo OWASP attack template library             | 🟡 hpt8001  | 3 ngày |
| 5 | Test từng loại attack riêng lẻ                | 🟡 hpt8001  | 3 ngày |
| 6 | Ghi log + record kết quả attack              | 🟡 hpt8001  | 2 ngày |
...
| 5 | Test healing actions riêng lẻ                 | 🟡 hpt8001  | 3 ngày |
| 6 | Viết docs cho Hephaestus API                  | 🟡 hpt8001  | 2 ngày |
...
| 4 | Thu thập data: MTTD, MTTR, Uptime            | 🟡 hpt8001  | 3 ngày |
| 5 | Record video demo (toàn bộ flow)              | 🟡 hpt8001  | 2 ngày |
| 6 | Tạo bảng so sánh Baseline vs Self-Healing     | 🟡 hpt8001  | 2 ngày |
...
| 2 | Viết báo cáo — phần bối cảnh + related works  | 🟡 hpt8001  | 4 ngày |
| 3 | Tạo slides bảo vệ                            | 🟡 hpt8001  | 3 ngày |
| 4 | Review + chỉnh báo cáo                       | 🔴 Bạn       | 3 ngày |
| 5 | Đóng gói source code (clean, docs)            | 🔴 Bạn       | 2 ngày |
| 6 | Tập bảo vệ (dry run)                         | Cả 2         | 2 ngày |
| 7 | Làm poster (nếu cần)                         | 🟡 hpt8001  | 2 ngày |
...
| D4  | **Được review** (nếu là code)     | Lead (bạn) đã review code của hpt8001               |
...
| "hpt8001 không biết làm gì"    | Template rõ ràng + pair programming 30 phút đầu |
