...
| S2  | **K8s Cluster Setup**    |                                                                    | Hoàng            | Tuần 1-2 | ⬜     |
...
| S3  | **Dev Environment**      |                                                                    | Hoàng + hp8001 | Tuần 2   | ⬜     |
...
| Task ID | Task                        | Subtasks                                                             | Assignee         | Target   | Status |
| ------- | --------------------------- | -------------------------------------------------------------------- | ---------------- | -------- | ------ |
| S4  | **Architecture Design**     |                                                                      | Hoàng + hp8001 | Tuần 3   | ⬜     |
...
| S5  | **Kafka Cluster Setup**     |                                                                      | Hoàng            | Tuần 3-4 | ⬜     |
...
| S6  | **Observability Stack**     |                                                                      | Hoàng + hp8001 | Tuần 3-4 | ⬜     |
...
| Task ID | Task                     | Subtasks                                                           | Assignee         | Target   | Status |
| ------- | ------------------------ | ------------------------------------------------------------------ | ---------------- | -------- | ------ |
| S7  | **Deploy Target App**    |                                                                    | Hoàng            | Tuần 5   | ⬜     |
...
| S8  | **Agent Gaia — Core**    |                                                                    | Hoàng + hp8001 | Tuần 5-6 | ⬜     |
...
| Task ID | Task                      | Subtasks                                                          | Assignee         | Target   | Status |
| ------- | ------------------------- | ----------------------------------------------------------------- | ---------------- | -------- | ------ |
| S8  | **Agent Gaia — Complete** | _(tiếp tục)_                                                      |                  |          |        |
...
| Task ID | Task                     | Subtasks                                                          | Assignee         | Target    | Status |
| ------- | ------------------------ | ----------------------------------------------------------------- | ---------------- | --------- | ------ |
| S9  | **Go Chaos Worker**      |                                                                   | Hoàng            | Tuần 9    | ⬜     |
...
| S10  | **Agent Nemesis — Core** |                                                                   | Hoàng + hp8001 | Tuần 9-10 | ⬜     |
...
**Mục tiêu Sprint**: Hoàn thiện Nemesis + End-to-end attack testing

| Task ID | Task                         | Subtasks                                                       | Assignee         | Target     | Status |
| ------- | ---------------------------- | -------------------------------------------------------------- | ---------------- | ---------- | ------ |
| S10  | **Agent Nemesis — Complete** | _(tiếp tục)_                                                   |                  |            |        |
|         |                              | 5.2.6 Implement CampaignScheduler (cron-based attacks)        | Hoàng            | Tuần 11    | ⬜     |
|         |                              | 5.2.7 Implement State Machine + Cooldown logic                 | Hoàng            |            | ⬜     |
|         |                              | 5.2.8 Dockerize + K8s Deployment manifest                      | Hoàng            | Tuần 12    | ⬜     |
|         |                              | 5.2.9 End-to-end test: Nemesis → Gaia detects all 3 attacks   | Hoàng            |            | ⬜     |
|         |                              | 5.2.10 Viết attack playbook documentation                      | 🟡 hp8001     |            | ⬜     |
|         |                              | 5.2.11 Tạo Grafana dashboard "Attack Campaign History"        | 🟡 hp8001     |            | ⬜     |

**✅ Milestone 4**: All 3 attack types executed + Gaia detects all

**📊 Phase 3 Deliverables**:

- [ ] Go Chaos Worker deployed (< 20MB image)
- [ ] Agent Nemesis deployed, LLM payload generation working
- [ ] All 3 attack vectors operational (SQLi, DDoS L7, Resource Exhaustion)
- [ ] Nemesis → Gaia detection loop verified
- [ ] Attack playbook documented

---

## 📦 PHASE 4: Agent Hephaestus — Blue Team (T04-T05/2026)

> **Mục tiêu Phase**: Phát triển Agent Hephaestus + Hoàn thiện vòng lặp Attack→Detect→Heal
> **Thời gian**: 2 tháng (04/2026 - 05/2026)
> **Hoàng**: Hephaestus core, K8s API integration, Full Loop | **hp8001**: Healing playbooks, metrics tracking, report Ch3-4

### Sprint 7: Hephaestus Core (Tuần 13-14)

**Mục tiêu Sprint**: Build Hephaestus với K8s API integration

| Task ID | Task                          | Subtasks                                                            | Assignee         | Target     | Status |
| ------- | ----------------------------- | ------------------------------------------------------------------- | ---------------- | ---------- | ------ |
| S11  | **Agent Hephaestus — Core**   |                                                                     | Hoàng            | Tuần 13-14 | ⬜     |
|         |                               | 7.1.1 Create Spring Boot module `agent-hephaestus`                  | Hoàng            |            | ⬜     |
|         |                               | 7.1.2 Implement Kafka consumer → `monitoring.alerts`                | Hoàng            |            | ⬜     |
|         |                               | 7.1.3 Implement K8s API client (Fabric8 / Official Java client)     | Hoàng            |            | ⬜     |
|         |                               | 7.1.4 Implement HealingAction: Scale pods                           | Hoàng            |            | ⬜     |
|         |                               | 7.1.5 Implement HealingAction: Block IP (NetworkPolicy)             | Hoàng            |            | ⬜     |
|         |                               | 7.1.6 Implement HealingAction: Rollback deployment                  | Hoàng            |            | ⬜     |
|         |                               | 7.1.7 Implement HealingAction: Restart pod                          | Hoàng            |            | ⬜     |
|         |                               | 7.1.8 Tạo healing playbooks documentation                           | 🟡 hp8001     |            | ⬜     |

### Sprint 8: Full Loop Integration (Tuần 15-16)

**Mục tiêu Sprint**: Hoàn thiện Hephaestus + End-to-end Full Loop

| Task ID | Task                             | Subtasks                                                           | Assignee         | Target     | Status |
| ------- | -------------------------------- | ------------------------------------------------------------------ | ---------------- | ---------- | ------ |
| S11  | **Agent Hephaestus — Complete**  | _(tiếp tục)_                                                       |                  |            |        |
|         |                                  | 7.1.9 Implement Priority Logic (Heal > Attack)                     | Hoàng            | Tuần 15    | ⬜     |
|         |                                  | 7.1.10 Implement Kafka producer → `healing.actions`               | Hoàng            |            | ⬜     |
|         |                                  | 7.1.11 Dockerize + K8s Deployment + RBAC ServiceAccount           | Hoàng            |            | ⬜     |
| S12  | **Full Loop End-to-End**         |                                                                    | Hoàng            | Tuần 15-16 | ⬜     |
|         |                                  | 7.2.1 Test Scenario 1: SQLi → Detect → Block IP                   | Hoàng            |            | ⬜     |
|         |                                  | 7.2.2 Test Scenario 2: DDoS → Detect → Scale                      | Hoàng            |            | ⬜     |
|         |                                  | 7.2.3 Test Scenario 3: Resource → Detect → Rollback               | Hoàng            |            | ⬜     |
|         |                                  | 7.2.4 Measure MTTD + MTTR for each scenario                       | Hoàng            |            | ⬜     |
|         |                                  | 7.2.5 Tạo Grafana dashboard "Hephaestus Actions"                  | 🟡 hp8001     |            | ⬜     |
|         |                                  | 7.2.6 Viết báo cáo Ch3-4 (Methodology + Implementation)          | 🟡 hp8001     |            | ⬜     |

**✅ Milestone 5**: Full Attack→Detect→Heal loop works E2E

**📊 Phase 4 Deliverables**:

- [ ] Agent Hephaestus deployed with all 4 healing actions
- [ ] Full Loop tested for all 3 scenarios
- [ ] Initial MTTD/MTTR measurements recorded
- [ ] Hephaestus Grafana dashboard live
- [ ] Report Ch3-4 draft complete

---

## 📦 PHASE 5: Experiments & War Game (T05-T06/2026)

> **Mục tiêu Phase**: Chạy thực nghiệm có kiểm soát + Thu thập dữ liệu cho báo cáo
> **Thời gian**: 2 tháng (05/2026 - 06/2026)

### Sprint 9: Formal Experiments (Tuần 17-18)

| Task ID | Task                         | Subtasks                                                            | Assignee         | Target     | Status |
| ------- | ---------------------------- | ------------------------------------------------------------------- | ---------------- | ---------- | ------ |
| S13  | **Baseline Measurement**     |                                                                     | Hoàng + hp8001 | Tuần 17    | ⬜     |
|         |                              | 9.1.1 Disable Hephaestus, simulate manual response                  | Hoàng            |            | ⬜     |
|         |                              | 9.1.2 Run 10 attack scenarios manually → record MTTD/MTTR           | Hoàng            |            | ⬜     |
|         |                              | 9.1.3 Run Control Group 1: K8s HPA only                            | Hoàng            |            | ⬜     |
|         |                              | 9.1.4 Run Control Group 2: Prometheus + Manual                      | Hoàng            |            | ⬜     |
| S14  | **ZERO DOOR Experiments**    |                                                                     | Hoàng + hp8001 | Tuần 17-18 | ⬜     |
|         |                              | 9.2.1 Run 30 attack scenarios (Experimental Group)                  | Hoàng            |            | ⬜     |
|         |                              | 9.2.2 Record all timestamps (attack_start, detect, heal_complete)  | Hoàng            |            | ⬜     |
|         |                              | 9.2.3 Export Prometheus data → CSV                                  | Hoàng            |            | ⬜     |
|         |                              | 9.2.4 Statistical analysis (Mean, P95, t-test)                     | 🟡 hp8001     |            | ⬜     |

### Sprint 10: War Game (Tuần 19-20)

| Task ID | Task                  | Subtasks                                                        | Assignee         | Target     | Status |
| ------- | --------------------- | --------------------------------------------------------------- | ---------------- | ---------- | ------ |
| S15  | **War Game**          |                                                                 | Hoàng            | Tuần 19-20 | ⬜     |
|         |                       | 10.1.1 Run all 3 attacks simultaneously (Stress Test)           | Hoàng            |            | ⬜     |
|         |                       | 10.1.2 Random attack timing (blind test) — shuffle scenarios   | Hoàng            |            | ⬜     |
|         |                       | 10.1.3 Record 4-hour continuous operation                       | Hoàng            |            | ⬜     |
|         |                       | 10.1.4 Capture Uptime during War Game                           | Hoàng            |            | ⬜     |
|         |                       | 10.1.5 Record Demo Video (5-10 phút)                            | Hoàng            |            | ⬜     |
|         |                       | 10.1.6 Phân tích kết quả War Game → Viết Ch5                   | 🟡 hp8001     |            | ⬜     |

**✅ Milestone 6**: All experiments complete, data collected

---

## 📦 PHASE 6: Report & Defense (Song song từ T03, hoàn thành T06/2026)

### Sprint 11-12: Finalization (Tuần 21-24)

| Task ID | Task                    | Subtasks                                                      | Assignee         | Target     | Status |
| ------- | ----------------------- | ------------------------------------------------------------- | ---------------- | ---------- | ------ |
| S16  | **Report Writing**      |                                                               | 🟡 hp8001     | Tuần 21-22 | ⬜     |
|         |                         | 11.1.1 Hoàn thiện Ch1-2 (Introduction + Literature Review)   | 🟡 hp8001     |            | ⬜     |
|         |                         | 11.1.2 Hoàn thiện Ch3-4 (Methodology + Implementation)       | 🟡 hp8001     |            | ⬜     |
|         |                         | 11.1.3 Viết Ch5 (Results + Analysis)                          | 🟡 hp8001     |            | ⬜     |
|         |                         | 11.1.4 Viết Ch6 (Conclusion + Future Work)                    | 🟡 hp8001     |            | ⬜     |
|         |                         | 11.1.5 Review toàn bộ báo cáo                                 | Hoàng + hp8001 |            | ⬜     |
| S17  | **Defense Preparation** |                                                               | Hoàng + hp8001 | Tuần 23-24 | ⬜     |
|         |                         | 11.2.1 Tạo Presentation Slides (20-25 slides)                 | 🟡 hp8001     |            | ⬜     |
|         |                         | 11.2.2 Rehearsal bảo vệ (2 lần)                               | Hoàng + hp8001 |            | ⬜     |
|         |                         | 11.2.3 Chuẩn bị Q&A (anticipate 10 câu hỏi khó)              | Hoàng + hp8001 |            | ⬜     |
|         |                         | 11.2.4 Final Demo video polish                                 | Hoàng            |            | ⬜     |
|         |                         | 11.2.5 Submit báo cáo cuối cùng                               | hp8001           |            | ⬜     |

**✅ Milestone 7**: Project Complete — Defense Ready

---

### 6.3. Tổng kết Sprint Progress

| Sprint | Phase   | Focus                | Owner           | Status |
| ------ | ------- | -------------------- | --------------- | ------ |
| S1     | Phase 1 | Foundation & Infra   | Hoàng           | ⬜     |
| S2     | Phase 1 | Architecture & Kafka | Hoàng + hp8001  | ⬜     |
| S3     | Phase 2 | Target App Deploy    | Hoàng           | ⬜     |
| S4     | Phase 2 | Agent Gaia           | Hoàng + hp8001  | ⬜     |
| S5     | Phase 3 | Go Worker + Nemesis  | Hoàng + hp8001  | ⬜     |
| S6     | Phase 3 | Nemesis Complete     | Hoàng + hp8001  | ⬜     |
| S7     | Phase 4 | Hephaestus Core      | Hoàng           | ⬜     |
| S8     | Phase 4 | Full Loop            | Hoàng + hp8001  | ⬜     |
| S9     | Phase 5 | Formal Experiments   | Hoàng + hp8001  | ⬜     |
| S10    | Phase 5 | War Game             | Hoàng           | ⬜     |
| S11    | Phase 6 | Report Writing       | hp8001          | ⬜     |
| S12    | Phase 6 | Defense Prep         | Hoàng + hp8001  | ⬜     |
